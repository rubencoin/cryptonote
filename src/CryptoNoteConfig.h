...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x6860; //addresses start with "eb"
...
const char     CRYPTONOTE_NAME[]                             = "rebcoin";
...
"192.168.1.145:17236", //"your_seed_ip1.com:8080",
